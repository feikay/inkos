...
const RULES = [
  ...
  },
  {
    type: "A",
    id: "panel-keyword",
    re: /气血条|血条|状态条|面板|属性|基础值|经验值?|等级条|数值(?:收益|消耗|倍率)|收益|性价比|战力|打[一二三四五六七八九十半\d.]+折|倍率|满额/giu,
  ...
  {
    type: "B",
    id: "fractional-body-state",
    re: /(?:恢复|回升|耗去|消耗|只剩|跌了|本源|视力|精血|气血|实力|战力|右臂|左眼|长到|剩)[^。！？\n]{0,16}(?:[一二三四五六七八九十半大]+成|大半|小半|一截|半滴|一整滴|五分之一|三分之二)|(?:[一二三四五六七八九十半大]+成|大半|小半|一截|半滴|一整滴|五分之一|三分之二)[^。！？\n]{0,16}(?:恢复|回升|耗去|消耗|只剩|跌了|本源|视力|精血|气血|实力|战力|右臂|左眼|长到|剩)/giu,
    reason: "成数和半滴并非必错，但若连续用于资源换算，会接近账本化表达。",
    suggestion: "人工判断：保留自然尺度，或改成更贴近痛觉、残损、气机强弱的描写。",
    autoFix: "no",
  },
  {
    type: "C",
